...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks, int teamnum = 7)
{
	...
	}
	{
		...
		AddRequirement(b.reqs, "blob", "mat_plasteel", "Plasteel", 15);
		AddRequirement(b.reqs, "blob", "mat_copperwire", "Copper Wire", 10);
		blocks[2].push_back(b);
	}
	{
	...
	{
		BuildBlock b(0, "plasteelfurnace", "$plasteelfurnace$", "Alien's Furnace\nA heavy furnace that produces up to 6x more ingots.\n$RED$Requires coal to smelt metal.$RED$$mat_coal$\n");
		AddRequirement(b.reqs, "blob", "mat_plasteel", "Iron Ingot", 150);
