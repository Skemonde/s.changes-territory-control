...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Sell Adv Automation for 1000 c.", "$COIN$", "coin-1000", "Sell blueprint for 1000 coins.");
		AddRequirement(s.requirements, "blob", "bp_automation_advanced", "Adv Automation Blueprint", 1);
		s.spawnNothing = true;
	}
	{
		ShopItem@ s = addShopItem(this, "Sell Energetics for 750 c.", "$COIN$", "coin-750", "Sell blueprint for 750 coins.");
