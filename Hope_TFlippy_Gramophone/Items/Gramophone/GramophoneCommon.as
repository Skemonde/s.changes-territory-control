...
const GramophoneRecord@[] records =
{
	...
	GramophoneRecord("March Rechnikov - March of Rivermen", "Disc_March_Rechnikov-March_of_Rivermen.ogg"),
	GramophoneRecord("Potomu chto mi - piloti - Because we are - pilots", "Disc_Potomu_chto_mi_-_piloti-Because_we_are_-_pilots.ogg"),
	GramophoneRecord("Vernulsya ya na rodinu - Returned to my homeland", "Disc_Vernuls'a_ya_na_rodinu-Returned_to_my_homeland.ogg"),
	...
	GramophoneRecord("Johny", "Disc_Johny.ogg"),
	...
	GramophoneRecord("Luftwaffe March", "Disc_LuftwaffeMarch.ogg"),
	...
	GramophoneRecord("Carnaval em Veneza", "Disc_CarnavalEmVeneza.ogg"),
	GramophoneRecord("Wo Alle Straßen Enden", "Disc_WoAlleStraßenEnden.ogg")
};