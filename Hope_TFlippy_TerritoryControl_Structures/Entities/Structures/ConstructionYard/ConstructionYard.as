...
void onInit(CBlob@ this)
{
	...
	//}
	{
		...
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 850);
	...
	//added by vladkvs193
	{
		ShopItem@ s = addShopItem(this, "Drone!", "$uav$", "uav", "$uav$\n\n\n\n\n" + "", false, true);
	...
	}
	{
		...
		AddRequirement(s.requirements, "blob", "mat_ironingot", "Iron Ingot", 78);
